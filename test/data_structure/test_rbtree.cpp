...
int main(int argc, char *argv[])
{
    ...
    {
        auto *tmp = node->Next();
        std::cout << "remove:" << MZX_CONTAINER_OF(node, Test, rbtree_link)->a
                  << " cur len:" << rbtree.Length() << std::endl;
        rbtree.Erase(node);
        node = tmp;
    }
    std::cout << "====:";
    ...
    std::cout << std::endl;
    std::vector<Test> ttt3{Test(0), Test(1), Test(2), Test(2), Test(3),
                           Test(4), Test(6), Test(4), Test(4)};
